...
flags.DEFINE_integer('checkpoint_interval', 3000, 'Checkpointing interval.')
flags.DEFINE_integer('lrf_update_frequency', 500, 'Update lrf every x timesteps.')
    ...
    for i in tqdm.tqdm(range(start_i, FLAGS.max_steps),
        ...
        if i >= FLAGS.start_training:
            ...
            if i % FLAGS.lrf_update_frequency == 0:
                ...
                # lrf.set_replay_buffer(replay_buffer)
